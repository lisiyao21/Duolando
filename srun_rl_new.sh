...
TOOLS="srun --mpi=pmi2 --cpus-per-task=40 --partition=$partition_name --cpus-per-task=16 --gres=gpu:$gpunum --ntasks-per-node 1  -n1 --job-name=${config_suffix}"
PYTHONCMD="python -u main_ac_new.py --config $1"
