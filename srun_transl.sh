...
TOOLS="srun --mpi=pmi2 --partition=$partition_name  --cpus-per-task=16   --ntasks-per-node 1 --gres=gpu:$gpunum -n1  --job-name=${config_suffix} "
PYTHONCMD="python -u main_transl.py --config $1"
