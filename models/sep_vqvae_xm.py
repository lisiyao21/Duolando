...
class SepVQVAEXM(nn.Module):
    ...
    def feat(self, zs, start_level=0, end_level=None, bs_chunks=1):
        ...
        return None, feat_down, None, None
    ...
    def decode(self, zs, start_level=0, end_level=None, bs_chunks=1):
        ...
        return x.view(b, t, -1), x_rot.view(b, t, -1), xshift
    ...
    def forward(self, x, xrot, xshift):
        ...
        # print(xlhand.shape, xlhandrot.shape, flush=True)
        # print((xlhand == np.nan).max(), (xlhandrot == np.nan).max())
        ...
        # print(loss_up, loss_down, loss_lhand, loss_rhand, flush=True)
